...
public class Gum extends Snack {
     ...
     */
    public Gum(String flavor, int pieces, double servingSize, boolean sugarFree, double weight, int calories, String productName, double price, int quantity, String dispenceLocation) {
